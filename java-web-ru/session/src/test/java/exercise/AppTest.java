...
class AppTest {
    ...
    void testLoginPass() throws Exception {
        ...
        assertThat(body1).contains("Enter");
        assertThat(body1).doesNotContain("Exit");
        ...
        assertThat(body3).contains("Exit");
        assertThat(body3).doesNotContain("Enter");
        ...
        assertThat(body4).contains("Enter");
        assertThat(body4).doesNotContain("Exit");
    }
