...
public class AppTest {
    ...
    void testCreateArticle() throws Exception {
        String content = "{\"name\": \"Test article\", \"body\": \"Test body\", \"categoryId\": 5}";
        mockMvc.perform(
                post("/articles")
        ...
        assertThat(actualArticle.getCategory().getCategoryId()).isEqualTo(5);
    ...
    void testUpdateArticle() throws Exception {
        ...
        var existingArticleId = TestUtils.getArticleIdByName(mockMvc, existingArticleName);
        String content = "{\"name\": \"Updated article\", \"body\": \"Updated body\", \"categoryId\":5 }";
        ...
        Article actualArticle = articleRepository.findById(existingArticleId).get();
    ...
    void testDeleteArticle() throws Exception {
        ...
        assertNull(articleRepository.findById(existingArticleId).orElse(null));
    }
}
